...
@section('breadcrumbs')
	...
	<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
		<a itemprop="item" href="public/users">
			<span itemprop="name">
				Users List
			</span>
		</a>
	...
	<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
		<a itemprop="item" href="public/users/{{ $user->id }}">
			<span itemprop="name">
				{{ $user->name }}
			</span>
		</a>
	...
	<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
		<a itemprop="item" href="public/users/{{ $user->id }}/edit">
			<span itemprop="name">
				Editing
			</span>
		</a>
			...
			{!! Form::model($user, array('action' => array('UsersManagementController@update', $user->id), 'method' => 'PUT')) !!}
				...
				<div class="mdl-card card-wide" style="width:100%;" itemscope itemtype="http://schema.org/Person">
				    ...
				    <div class="mdl-card__actions padding-top-0">
						<div class="mdl-grid padding-top-0">
							<div class="mdl-cell mdl-cell--12-col padding-top-0 margin-top-0 margin-left-1-1">
								...
								<a href="public/users/{{$user->id}}" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-color--primary mdl-color-text--white margin-bottom-1 margin-top-1 margin-top-0-desktop margin-right-1 padding-left-1 padding-right-1 " title="view profile">
								...
								{{-- VIEW PROFILE BUTTON --}}
								<a href="public/profile/{{Auth::user()->name}}" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-color--blue-600 mdl-color-text--white margin-bottom-1 margin-top-1 margin-top-0-desktop margin-right-1 padding-left-1 padding-right-1 " title="view profile">
				    ...
				    <div class="mdl-card__menu">
						...
						{{-- VIEW PROFILE ICON --}}
						<a href="public/profile/{{Auth::user()->name}}" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect" title="View User Profile">
							<i class="material-icons">person_outline</i>
						</a>

						{{-- VIEW ACCOUNT ICON --}}
						<a href="public/users/{{$user->id}}" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect" title="View User Account">
